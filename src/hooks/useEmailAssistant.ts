        ...
        try {
            if (currentStep === 'parse') {
                ...
                if (input.toLowerCase() === 'skip') {
                    ...
                    const newRecipientName = extractData.recipientName || emailData.recipientName;
                    const newSenderName = extractData.senderName || emailData.senderName;
